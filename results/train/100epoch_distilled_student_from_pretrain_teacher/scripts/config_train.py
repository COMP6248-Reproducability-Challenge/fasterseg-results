...
"""Data Dir"""
C.dataset_path = "/home/asg1g18/FasterSeg/tools/datasets/cityscapes/"
...
C.num_eval_imgs = 100 # number of validation images
...
"""Train Config"""
C.lr = 0.01 # 0.01learning rate for updating supernet weight (NOT arch params)
C.momentum = 0.9 # SGD momentum
C.weight_decay = 5e-4 # SGD weight decay
C.nepochs = 100 # how many epochs to train
...
if C.mode == "teacher":
    ...
    C.stem_head_width = [(8./12, 8./12)] # width ratio (#channel / Fch) for [teacher, student]
#C.stem_head_width = [(1, 1)] # width ratio (#channel / Fch) for [teacher, student]
    C.load_path = "/home/asg1g18/FasterSeg/train/fasterseg" # path to the searched directory
    ...
    C.load_path = "/home/asg1g18/FasterSeg/train/fasterseg" # path to the searched directory
    C.teacher_path = "/home/asg1g18/FasterSeg/train/fasterseg" # where to load the pretrained teacher's weight
...
C.eval_path = "train-512x1024_student_batch12-20220507-131130" # path to pretrained directory to be evaluated
